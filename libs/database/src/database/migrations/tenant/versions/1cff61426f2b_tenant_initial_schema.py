...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("is_resend", sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_index(
        op.f("ix_webhook_partners_tenant_id"), "webhook_partners", ["tenant_id"], unique=False
    )
    op.create_table(
        "as2_partnerships",
        sa.Column("id", sa.UUID(), server_default=sa.text("gen_random_uuid()"), nullable=False),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.CheckConstraint(
            "(as2_partner_id IS NOT NULL)::integer + (sftp_partner_id IS NOT NULL)::integer = 1",
