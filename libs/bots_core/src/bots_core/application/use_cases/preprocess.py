...
from bots_core.infrastructure.config.botsconfig import OK, ERROR, DONE, FILEIN, FILEOUT
from bots_core.utils.botslib import gettext as _
from bots_core.domain.exceptions import InMessageError, txtexc
        ...
        if found.group("x12"):
            ...
            for char in edifile[headpos:headpos + 120]:
                ...
                if count == 4:
                    ...
                    record_sep = char
                    break
            escaped_record_sep = re.escape(record_sep)
            foundtrailer = re.search(
                f"{escaped_record_sep}"
                r"\s*"
                "I[\n\r]*E[\n\r]*A"
                ".+?"
                f"{escaped_record_sep}",
            ...
            foundtrailer = re.search(
                ...
                f"{escaped_record_sep}"      # segment separator
