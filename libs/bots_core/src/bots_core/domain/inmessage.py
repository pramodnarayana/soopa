...
class xml(Inmessage):
    ...
    def initfromfile(self):
        ...
        if self.ta_info['messagetype'] == 'mailbag':
            ...
            # Dict consist of 'xpath', 'messagetype' and (optionally) 'tag' or 'content'.
            # 'xpath' is a xpath to use on xml-file (using elementtree xpath functionality)
            # if found, and 'tag' or 'content' in the dict;
            # if 'tag' or 'content' is equal to value found by xpath-search, then set messagetype.
