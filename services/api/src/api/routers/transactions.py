...
async def list_transactions(
    ...
    """
    async with uow:
        messages = await uow.transactions.list_transactions(  # type: ignore
            tenant_id=tenant_id,
            limit=limit,
            offset=offset,
...
async def get_transaction_thread(
    ...
    """
    async with uow:
        json_records = await uow.transactions.get_transaction_thread(tenant_id, key, value)  # type: ignore
        items = []
...
async def get_transaction(
    ...
    """
    async with uow:
        result = await uow.transactions.get_transaction(tenant_id, trace_id)  # type: ignore
