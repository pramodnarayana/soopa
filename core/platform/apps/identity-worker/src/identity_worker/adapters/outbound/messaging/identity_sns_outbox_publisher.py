...
class IdentitySnsOutboxPublisher(OutboxPublisherPort):
    """
    Publishes Identity outbox events to an AWS SNS Topic.
    """
    ...
    async def __aenter__(self) -> "IdentitySnsOutboxPublisher":
