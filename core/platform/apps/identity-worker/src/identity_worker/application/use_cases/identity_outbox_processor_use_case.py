...
class IdentityOutboxProcessorUseCase:
    """
    ...
    def stop(self) -> None:
        ...
        logger.info("identity_outbox_processor_stopped", worker_id=self.worker_id)
    ...
    async def process_pending(self) -> bool:
        ...
        logger.debug("identity_relay_events_claimed", worker_id=self.worker_id, count=len(events))
