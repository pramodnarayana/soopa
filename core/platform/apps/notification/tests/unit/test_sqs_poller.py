...
from notification.adapters.inbound.sqs_poller import poll_sqs_queue
...
async def test_poll_sqs_queue_success():
    ...
    with patch("notification.adapters.inbound.sqs_poller.aioboto3.Session") as mock_session_class:
