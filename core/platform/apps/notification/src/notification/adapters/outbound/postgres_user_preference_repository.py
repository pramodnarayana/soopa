...
from ...ports.interfaces import UserNotificationPreferenceRepositoryPort

logger = structlog.get_logger(__name__)


class PostgresUserNotificationPreferenceRepository(UserNotificationPreferenceRepositoryPort):
