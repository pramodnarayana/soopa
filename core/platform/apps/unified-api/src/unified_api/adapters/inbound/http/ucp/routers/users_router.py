...
from unified_api.adapters.inbound.http.ucp.dtos.user_dtos import (
    CreateUserRequest,
    ToggleUserAction,
...
@router.get(
    "",
    dependencies=[Depends(RequireCapability(Capability.USERS_READ))],
...
async def get_users(
    ...
    return UsersListResponse(result=result)
