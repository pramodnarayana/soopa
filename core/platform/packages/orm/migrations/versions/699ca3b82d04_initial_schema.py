...
def upgrade() -> None:
    """Upgrade schema."""
    op.execute("CREATE SCHEMA IF NOT EXISTS ucp;")
    ...
    op.create_index(
        op.f("ix_ucp_scheduled_jobs_name"), "scheduled_jobs", ["name"], unique=False, schema="ucp"
    )
    op.create_index(
        op.f("ix_ucp_scheduled_jobs_next_run_at"),
        "scheduled_jobs",
        ["next_run_at"],
        unique=False,
        schema="ucp",
    ...
    op.create_index(
        op.f("ix_ucp_scheduled_jobs_status"),
        "scheduled_jobs",
        ["status"],
        unique=False,
        schema="ucp",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_ucp_system_audit_log_trace_id"), table_name="system_audit_log", schema="ucp"
    )
    ...
    op.drop_index(
        op.f("ix_ucp_scheduled_jobs_next_run_at"), table_name="scheduled_jobs", schema="ucp"
    )
