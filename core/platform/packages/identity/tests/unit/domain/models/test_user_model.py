...
def test_user_create_and_properties():
    user = User.create(id="iam_usr_123", idp_user_id=None, email="test@test.com", name="Test User")
...
def test_user_set_idp_user_id():
    user = User.create(id="iam_usr_123", idp_user_id=None, email="test@test.com", name="Test")
