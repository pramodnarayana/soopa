...
export function FilterForm({ fields, onAdd, onCancel }: FilterFormProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 bg-slate-50/50 p-2 rounded-xl border border-slate-200/60 shadow-sm animate-in fade-in slide-in-from-top-2">
