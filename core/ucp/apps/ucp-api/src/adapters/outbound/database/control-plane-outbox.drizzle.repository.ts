...
@Injectable()
export class ControlPlaneOutboxDrizzleRepository implements IControlPlaneOutboxRepository {
  private readonly logger = new Logger(ControlPlaneOutboxDrizzleRepository.name);
