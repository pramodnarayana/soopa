...
CREATE TABLE "ucp"."tenant_shards" (
	"tenant_id" varchar(128) NOT NULL,
	"shard_id" varchar(128) NOT NULL,
	"shard_schema" varchar(255) DEFAULT 'public' NOT NULL,
	"tier" varchar(50) DEFAULT 'standard' NOT NULL,
	"allow_private_as2" boolean DEFAULT false NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "ucp"."outbox_events" (
	"id" varchar(128) PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "ucp"."tenant_subscriptions" (
	"tenant_id" varchar(128) NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "ucp"."tenant_subscriptions" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
ALTER TABLE "ucp"."outbox_events" ADD CONSTRAINT "outbox_events_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "ucp"."tenants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ucp"."tenant_subscriptions" ADD CONSTRAINT "tenant_subscriptions_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "ucp"."tenants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ucp"."tenant_subscriptions" ADD CONSTRAINT "tenant_subscriptions_app_id_apps_id_fk" FOREIGN KEY ("app_id") REFERENCES "ucp"."apps"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
