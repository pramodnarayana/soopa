...
class AppSubscriptionManager:
    """
    Subscribes to UCP domain events and manages the application subscriptions registry.
    (e.g., allocating a database shard to a tenant, mapping the app subscription).
