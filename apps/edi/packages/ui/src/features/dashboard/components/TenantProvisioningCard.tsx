import { AlertCircle, Database, Lock, RefreshCcw, Shield } from 'lucide-react';
...
export function TenantProvisioningCard({
  isLoading,
  error,
  userProfile,
}: TenantProvisioningCardProps) {
  return (
