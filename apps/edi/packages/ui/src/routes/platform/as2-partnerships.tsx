...
import { AS2PartnershipsTable } from '../../features/partners/components/AS2PartnershipsTable';
import { CreateAS2PartnershipModal } from '../../features/partners/components/CreateAS2PartnershipModal';
import {
  AS2PartnersProvider,
  useAS2Partners,
} from '../../features/partners/context/AS2PartnersContext';

export function AS2PartnershipsPage() {
  return (
    <AS2PartnersProvider>
  ...
  return (
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        ...
        {!combinedError && <CreateAS2PartnershipModal availablePartners={safePartners} />}
      </div>
      {combinedError ? (
