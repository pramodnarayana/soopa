...
Revision ID: d09f3e74ebd0
Revises:
Create Date: 2026-08-28 23:22:26.455194
...
from edi.adapters.outbound.database.models.data_plane import SanitizedText

# revision identifiers, used by Alembic.
revision: str = "d09f3e74ebd0"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_edi_ack_receipts_tenant_id"),
        "ack_receipts",
        ["tenant_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_ack_receipts_trace_id"),
        "ack_receipts",
        ["trace_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_api_gateway_parent_trace_id"),
        "api_gateway",
        ["parent_trace_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_api_gateway_tenant_id"),
        "api_gateway",
        ["tenant_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_api_gateway_trace_id"), "api_gateway", ["trace_id"], unique=False, schema="edi"
    )
    op.create_table(
        "as2_partners",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_edi_audit_log_tenant_id"), "audit_log", ["tenant_id"], unique=False, schema="edi"
    )
    op.create_index(
        op.f("ix_edi_audit_log_trace_id"), "audit_log", ["trace_id"], unique=False, schema="edi"
    )
    op.create_table(
        "edi_json",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_edi_edi_json_parent_trace_id"),
        "edi_json",
        ["parent_trace_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_edi_json_tenant_id"), "edi_json", ["tenant_id"], unique=False, schema="edi"
    )
    op.create_index(
        op.f("ix_edi_edi_json_trace_id"), "edi_json", ["trace_id"], unique=False, schema="edi"
    )
    op.create_index(
        op.f("ix_edi_edi_json_trading_partner_id"),
        "edi_json",
        ["trading_partner_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_edi_json_transaction_type"),
        "edi_json",
        ["transaction_type"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_edi_messages_parent_trace_id"),
        "edi_messages",
        ["parent_trace_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_edi_messages_tenant_id"),
        "edi_messages",
        ["tenant_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_edi_messages_trace_id"),
        "edi_messages",
        ["trace_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_edi_messages_trading_partner_id"),
        "edi_messages",
        ["trading_partner_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_jobs_tenant_id"), "jobs", ["tenant_id"], unique=False, schema="edi"
    )
    op.create_index(op.f("ix_edi_jobs_trace_id"), "jobs", ["trace_id"], unique=False, schema="edi")
    op.create_table(
    ...
    op.create_index(
        op.f("ix_edi_processed_events_tenant_id"),
        "processed_events",
        ["tenant_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_webhooks_tenant_id"), "webhooks", ["tenant_id"], unique=False, schema="edi"
    )
    op.create_table(
        "as2_partnerships",
    ...
    op.create_index(
        op.f("ix_edi_as2_partnerships_tenant_id"),
        "as2_partnerships",
        ["tenant_id"],
        unique=False,
        schema="edi",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_edi_as2_partnerships_tenant_id"), table_name="as2_partnerships", schema="edi"
    )
    ...
    op.drop_index(
        op.f("ix_edi_processed_events_tenant_id"), table_name="processed_events", schema="edi"
    )
    op.drop_table("processed_events", schema="edi")
    op.drop_index(
        "ix_tenant_outbox_pending",
        table_name="outbox",
        schema="edi",
    ...
    op.drop_index(op.f("ix_edi_jobs_trace_id"), table_name="jobs", schema="edi")
    op.drop_index(op.f("ix_edi_jobs_tenant_id"), table_name="jobs", schema="edi")
    op.drop_table("jobs", schema="edi")
    op.drop_index("ix_edi_msgs_sender_recv", table_name="edi_messages", schema="edi")
    op.drop_index(
        op.f("ix_edi_edi_messages_trading_partner_id"), table_name="edi_messages", schema="edi"
    )
    op.drop_index(op.f("ix_edi_edi_messages_trace_id"), table_name="edi_messages", schema="edi")
    op.drop_index(op.f("ix_edi_edi_messages_tenant_id"), table_name="edi_messages", schema="edi")
    op.drop_index(
        op.f("ix_edi_edi_messages_parent_trace_id"), table_name="edi_messages", schema="edi"
    )
    op.drop_table("edi_messages", schema="edi")
    op.drop_index("ix_edi_json_sender_recv", table_name="edi_json", schema="edi")
    op.drop_index(
        "ix_edi_json_business_metadata", table_name="edi_json", schema="edi", postgresql_using="gin"
    )
    op.drop_index(op.f("ix_edi_edi_json_transaction_type"), table_name="edi_json", schema="edi")
    op.drop_index(op.f("ix_edi_edi_json_trading_partner_id"), table_name="edi_json", schema="edi")
    op.drop_index(op.f("ix_edi_edi_json_trace_id"), table_name="edi_json", schema="edi")
    op.drop_index(op.f("ix_edi_edi_json_tenant_id"), table_name="edi_json", schema="edi")
    op.drop_index(op.f("ix_edi_edi_json_parent_trace_id"), table_name="edi_json", schema="edi")
    op.drop_table("edi_json", schema="edi")
    op.drop_index(op.f("ix_edi_audit_log_trace_id"), table_name="audit_log", schema="edi")
    op.drop_index(op.f("ix_edi_audit_log_tenant_id"), table_name="audit_log", schema="edi")
    op.drop_table("audit_log", schema="edi")
    op.drop_index(op.f("ix_edi_as2_partners_tenant_id"), table_name="as2_partners", schema="edi")
    op.drop_table("as2_partners", schema="edi")
    op.drop_index(op.f("ix_edi_api_gateway_trace_id"), table_name="api_gateway", schema="edi")
    op.drop_index(op.f("ix_edi_api_gateway_tenant_id"), table_name="api_gateway", schema="edi")
    op.drop_index(
        op.f("ix_edi_api_gateway_parent_trace_id"), table_name="api_gateway", schema="edi"
    )
    op.drop_table("api_gateway", schema="edi")
    op.drop_index(op.f("ix_edi_ack_receipts_trace_id"), table_name="ack_receipts", schema="edi")
    op.drop_index(op.f("ix_edi_ack_receipts_tenant_id"), table_name="ack_receipts", schema="edi")
    op.drop_table("ack_receipts", schema="edi")
    # ### end Alembic commands ###
