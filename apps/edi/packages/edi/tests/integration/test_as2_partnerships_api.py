...
async def test_as2_partnership_lifecycle(platform_client: AsyncClient):
    ...
    res_partnership = await platform_client.post(
        "/api/v1/as2/partnerships", json=partnership_payload
    )
    ...
    res_list = await platform_client.get("/api/v1/as2/partnerships")
    ...
    res_list_after = await platform_client.get("/api/v1/as2/partnerships")
