...
POST /api/v1/as2/partnerships/{id}/test
...
def test_test_as2_partnership_success(client_factory, fake_uow):
    ...
    response = client.post(f"/api/v1/as2/partnerships/{partnership_id}/test")
...
def test_test_as2_partnership_not_found(client_factory):
    ...
    response = client.post(f"/api/v1/as2/partnerships/{uuid.uuid4()!s}/test")
