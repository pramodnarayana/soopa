...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_edi_scheduled_jobs_name"), "scheduled_jobs", ["name"], unique=False, schema="edi"
    )
    op.create_index(
        op.f("ix_edi_scheduled_jobs_next_run_at"),
        "scheduled_jobs",
        ["next_run_at"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_scheduled_jobs_status"),
        "scheduled_jobs",
        ["status"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_system_audit_log_trace_id"),
        "system_audit_log",
        ["trace_id"],
        unique=False,
        schema="edi",
    ...
    op.create_index(
        op.f("ix_edi_api_tokens_tenant_id"), "api_tokens", ["tenant_id"], unique=False, schema="edi"
    )
    op.create_table(
        "as2_partners",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_edi_system_audit_log_trace_id"), table_name="system_audit_log", schema="edi"
    )
    ...
    op.drop_index(
        op.f("ix_edi_scheduled_jobs_next_run_at"), table_name="scheduled_jobs", schema="edi"
    )
