...
async def main() -> None:
    ...
    try:
        ...
        def shutdown_handler(*args: object) -> None:
            logger.info("edi_cp_cleanup_shutdown_signal_received")
            stop_event.set()
        ...
        logger.info("edi_cp_cleanup_cancelled")
    except Exception:
        logger.exception("edi_cp_cleanup_failed")
        raise
    finally:
        logger.info("edi_cp_cleanup_shutting_down")
        await container.dispose()
        logger.info("edi_cp_cleanup_stopped")
