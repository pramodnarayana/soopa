...
async def test_tenant_uow_provider_success(test_db_router: DatabaseRouterPort) -> None:
    ...
    async for session in test_db_router.get_global_session():
    ...
    real_resolver = TenantResolver(db_router=test_db_router, ttl_secs=300)
