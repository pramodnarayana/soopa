...
from config_sync_worker.ports.outbound.outbox_relay_publisher_port import OutboxRelayPublisherPort
from config_sync_worker.ports.outbound.outbox_relay_repository_port import RelayOutboxEvent

logger = structlog.get_logger(__name__)


class EdiControlPlaneOutboxSnsPublisher(OutboxRelayPublisherPort):
