...
async def _poll_loop(
    ...
    while True:
        try:
            ...
            tasks = [_process_message_task(queue_name, msg, processor_func) for msg in messages]
...
async def poll_sqs_queue(
    ...
    try:
        ...
        logger.exception("sqs_client_or_queue_initialization_failed", queue_name=queue_name)
        raise
