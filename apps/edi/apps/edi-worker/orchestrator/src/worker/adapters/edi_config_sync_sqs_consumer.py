...
from worker.ports.outbound.ucp_event_listener_port import UcpEventListenerPort, UcpEventMessage

logger = structlog.get_logger(__name__)


class EdiConfigSyncSqsConsumer(UcpEventListenerPort):
    def __init__(self, endpoint_url: str | None = None, queue_name: str = "edi-config-sync.fifo"):
